...
/**
 * @extends \Illuminate\Database\Eloquent\Factories\Factory<\App\Models\ArsipGugatan>
 */
class ArsipGugatanFactory extends Factory
{
    /**
    ...
    public function definition(): array
    {
        ...
        $noBerkas = "{$noUrut}.Pdt.G.{$tahun}.PN Kmn";
        ...
        $filePath = "arsip_gugatan/{$fileName}";

        if (!Storage::disk('public')->exists('arsip_gugatan')) {
            Storage::disk('public')->makeDirectory('arsip_gugatan');
        }
